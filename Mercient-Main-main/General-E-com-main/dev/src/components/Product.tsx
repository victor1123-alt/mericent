                ...
                >
                  ...
                  <div className="px-2 py-4 lg:p-4 text-start">
                    ...
                    <button
                      ...
                      disabled={wear.quantity !== undefined && wear.quantity <= 0}
                      className={`w-full flex items-center justify-center gap-2 font-medium py-2 rounded-md transition-colors duration-300 ${wear.quantity !== undefined && wear.quantity <= 0 ? 'bg-gray-400 text-gray-600 cursor-not-allowed' : 'bg-primary text-white hover:bg-blue-600'}`}
                    >
                      <BsCartPlus /> {wear.quantity !== undefined && wear.quantity <= 0 ? 'Out of Stock' : wear.button}
                    </button>
                  </div>
                </div>
              );
