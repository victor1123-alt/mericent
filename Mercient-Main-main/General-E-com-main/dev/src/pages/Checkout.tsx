...
const CheckoutPage: React.FC = () => {
  ...
  const proceedToPayment = async (order: Order | null) => {
    ...
    setProcessing(true);
    try {
      // Clear shipping details from localStorage after order confirmation
      localStorage.removeItem('checkout_shipping_state_v1');
      localStorage.removeItem('checkout_delivery_v1');
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
              ...
              <ShippingSelector
                ...
                disabled={deliveryInfo.countryName !== "Nigeria"}
              />
