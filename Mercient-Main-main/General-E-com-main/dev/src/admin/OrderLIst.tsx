  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md mt-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg text-center">
          <div className="lg:text-[17px]  text-xl font-bold text-green-600 dark:text-green-400">{formatCurrency(orderStats.totalRevenue)}</div>
          <div className="text-xs text-green-600 dark:text-green-400">Total Revenue</div>
        </div>
      </div>

      {/* Filter Controls */}
      <div className="flex items-center justify-between mb-4 lg:flex-row flex-col gap-4">
        ...
        {(!filteredOrders || filteredOrders.length === 0) ? (
          ...
          filteredOrders.map((order, index) => (
            <div key={order._id || order.orderNumber || index} className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              {/* Order Header */}
              <div className="flex flex-col lg:flex-row gap-3 items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3 gap-2 mb-1 flex-wrap">
